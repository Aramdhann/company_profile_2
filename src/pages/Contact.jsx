    ...
    <>
      ...
      <div className="flex flex-col justify-center mx-auto container">
        ...
        <div className="flex flex-wrap gap-5 justify-center mx-auto px-5">
          ...
          <div
            data-aos="fade-up"
            className="bg-primary py-8 px-5 w-full sm:w-96 mb-8 rounded-xl h-fit"
          >
            <div className="flex flex-col gap-5">
              ...
              <form className="flex flex-col gap-4">
                <div className="dropdown">
                  <label
                    tabIndex={0}
                    className={`text-center p-4 rounded-xl hover:bg-[#E1BC3A] w-full flex bg-secondary font-bold justify-between items-center ${
                      dropdownError ? "border border-red-500" : ""
                    }`}
                  >
